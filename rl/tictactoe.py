class TicTacToe(object):
	"""
	Tic Tac Toe is the game class that handles win conditions, board state updates, and checks validity of moves
	"""
	...
	def check_win_condition(self):
		...
		l = [row_1, row_2, row_3, col_1, col_2, col_3, diag_1, diag_2]
